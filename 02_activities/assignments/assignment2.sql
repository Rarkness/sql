...
WITH vendors_products AS (
    SELECT v.vendor_name, p.product_name, cp.cost_to_customer_per_qty
...
SELECT 
    vp.vendor_name,
    vp.product_name,
    SUM(5 * vp.cost_to_customer_per_qty) AS total_revenue
...
WHERE product_name = 'Apple Pie'
  AND snapshot_timestamp < '2024-01-01 00:00:00';
